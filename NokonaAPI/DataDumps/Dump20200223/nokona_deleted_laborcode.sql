...
--
-- Table structure for table `deleted_laborcode`
--

DROP TABLE IF EXISTS `deleted_laborcode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `deleted_laborcode` (
...
--
-- Dumping data for table `deleted_laborcode`
--
...
-- Dump completed on 2020-02-23 11:51:41
