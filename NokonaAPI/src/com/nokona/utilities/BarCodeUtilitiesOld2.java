...
public class BarCodeUtilitiesOld2 {
...
//		System.out.println("Final is " + strBarCode);
	...
	public static String generateEmployeeLabels(Employee emp, int page_quantity) throws NullInputDataException {
		...
		fBarCode = BarCodeUtilitiesOld2.formatBarCode(fBarCode);
		String employee = (emp.getFirstName() + " " + emp.getLastName() + " - " + emp.getEmpId()).replaceAll(" ", "_");
		String cvtBarCode = BarCodeUtilitiesOld2.convertBarCode2of5(fBarCode);
...
//				double rate = isRH ? td2.getHourlyRateSAH() * 1.1 : td2.getHourlyRateSAH();
...

			{
				...
				// Value is " + fBarCode2);
				strCvtBarCode0 = convertBarCode2of5(BarCodeUtilitiesOld2.formatBarCode(fBarCode0));
				System.out.println("***********************" + strCvtBarCode0);
				strCvtBarCode1 = convertBarCode2of5(BarCodeUtilitiesOld2.formatBarCode(fBarCode1));
				strCvtBarCode2 = convertBarCode2of5(BarCodeUtilitiesOld2.formatBarCode(fBarCode2));
