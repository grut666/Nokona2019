...
class TestOperationResource {
	...
	public void testOperationGoodGet() throws DatabaseException {
		Mockito.when(db.getOperation(Mockito.anyString()))
				.thenReturn(new Operation(9693,"A55", "INSTALL RUBBER IN POCKET",3, .0225,0, 2));
...
//
	...
	public void testOperationsGoodPut() throws DatabaseException {
		...
		assertEquals(200, opResource
				.updateOperation("A55", new Operation(9693, "A55", "INSTALL RUBBER IN POCKET",3,.0225,0, 2)).getStatus());
	}

	@Test
	public void testOperationsPut400() throws DatabaseException {
		assertEquals(400, opResource
				.updateOperation("AZZ", new Operation(9693, "A55", "INSTALL RUBBER IN POCKET",3,.0225,0, 2)).getStatus());
	}
...
//
	...
	public void testOperationsAdd201() throws DatabaseException {
		assertEquals(201,
				opResource.addOperation(new Operation(9693,"A55", "INSTALL RUBBER IN POCKET",3, .0225,0, 2)).getStatus());
	}
